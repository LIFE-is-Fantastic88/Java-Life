...
public class MainMenu_view extends JFrame implements ActionListener{
	...
	private Controller_home c;
	public MainMenu_view(Controller_home controller) {
		this.c = controller;
		setTitle("Main Menu");
		setSize(700, 500);
	...
	public void actionPerformed(ActionEvent arg0) {
		controller.action(cmb_from.getSelectedIndex(),cmb_to.getSelectedIndex(),
				txt_day.getText(),txt_month.getText(),txt_year.getText(),
				txt_Rday.getText(),txt_Rmonth.getText(),txt_Ryear.getText(),
				txt_adult.getText(),txt_child.getText(),txt_infant.getText(),
