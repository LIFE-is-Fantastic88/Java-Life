...
public class RAIN_KEEP_FLOW1 {
	...
	public static void main(String[] args) {
		...
		for (int q = 1; q <= numnum; numnum++) {
			...
			String monthname[] = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov",
					"Dec" };
			...
			for (int yearnum1 = 0; yearnum1 < year; yearnum1++) {
				...
				for (int month1 = 0; month1 < 12; month1++) {
					...
					if (month1 == 11) {
						...
						System.out.println("Year " + year2 + ": Sum: " + df.format(sum) + " Avg: "+ df.format(average));
					}
				}
				year2++;
			}
