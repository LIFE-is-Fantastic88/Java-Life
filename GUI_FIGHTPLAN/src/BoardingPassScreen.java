...
public class BoardingPassScreen extends JFrame{
	...
	public BoardingPassScreen(Flight f, BoardingPass bp) {
		...
		JLabel piclabel2=new JLabel(classtype);
		...
		JLabel label4=new JLabel(bp.getPassenger().getName());
		label4.setFont(fontValue);
		label4.setForeground(Color.BLACK);
		middlepanel4.add(label4);
		JLabel label5=new JLabel(bp.getPassenger().getFrequentFlyerNum());
		label5.setFont(fontValue);
		label5.setForeground(Color.BLACK);
		middlepanel5.add(label5);
		int secnum=bp.securityNum();
		String str=Integer.toString(secnum);
		JLabel label6=new JLabel(str);
		...
		JLabel labela14=new JLabel("Gate Opens");
		...
		JLabel labela19=new JLabel(String.valueOf(bp.getGate()));
		labela19.setFont(fontValue);
		labela19.setForeground(Color.BLACK);
		JLabel labela20=new JLabel(bp.getGateOpen());
		labela20.setFont(fontValue);
		labela20.setForeground(Color.BLACK);
		JLabel labela21=new JLabel(String.valueOf(bp.getPassenger().getTicketClass()));
		labela21.setFont(fontValue);
		labela21.setForeground(Color.BLACK);
		JLabel labela22=new JLabel(bp.getPassenger().getPNR());
		labela22.setFont(fontValue);
		labela22.setForeground(Color.BLACK);
		JLabel labela23=new JLabel(bp.getSeat());
		labela23.setFont(fontValue);
		labela23.setForeground(Color.BLACK);
		JLabel labela24=new JLabel(bp.getPassenger().getETicketNum());
