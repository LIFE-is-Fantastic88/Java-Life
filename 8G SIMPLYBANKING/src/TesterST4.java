...
public class TesterST4{
	...
	public static void addNewLoan(BankLoanList t, BankLoan m){
		...
		if(t.addLoan(m))
			System.out.println("Creation of a new account: "+m.getAccount().getAccNumber()+" is successfull");
		else
	...
	public static void displayLoanInfo(BankLoanList t, ArrayList <BankLoan> bloan ){
		int totalHighLoan;
		int longInstallment;
		...
		totalHighLoan = t.calculateHighLoan();
		System.out.println("\n\nTotal loan higher or equal to RM500,000: "+totalHighLoan);

		longInstallment = t.calculateLongestInstallment();
		System.out.println("Total monthly installment higher than 25 years: "+longInstallment);
