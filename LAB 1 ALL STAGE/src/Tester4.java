...
public class Tester4 {
	...
	public static void displayInfo(StudentList t, ArrayList <Student> list ){
		...
		for	(Student m: list){
			...
			System.out.println(m.getFirstName()+" "+m.getLastName()+": Continuous assessment: "+m.getContinuousAssessment()+ ", Final exam: "+m.getFinalExam40percent()+ ", Overall marks: "+m.getAllMarks()+ ", GRADE: "+m.getGrade());
		}
